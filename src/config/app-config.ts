...
const MPT_IAM_URL = 'https://iam-uat.mptjo.com.mm:8000';
...
const configs: Record<string, AppConfig> = {
    dev: {
        ...
        appName: 'A365 HR',
        appVersion: import.meta.env.VITE_APP_VERSION || '1.0.28',
    ...
    mpt: {
        ...
        baseUrl: import.meta.env.VITE_BASE_URL || 'https://hrms-uat.mptjo.com.mm:8081/',
        authUrl: import.meta.env.VITE_AUTH_URL || MPT_IAM_URL + '/api/auth/',
        iamUrl: import.meta.env.VITE_IAM_URL || MPT_IAM_URL,
        mainUrl: import.meta.env.VITE_MAIN_URL || 'https://hrapp-uat.mptjo.com.mm:8080/',
        payslipUrl: import.meta.env.VITE_PAYSLIP_URL || 'https://hrapp-uat.mptjo.com.mm:8083/',
        chatUrl: import.meta.env.VITE_CHAT_URL || MPT_IAM_URL + '/api/',
        wsUrl: import.meta.env.VITE_WS_URL || 'wss://iam-uat.mptjo.com.mm:8000/api',
        appName: 'A365 HR',
        appVersion: import.meta.env.VITE_APP_VERSION || '1.0.28',
        appId: import.meta.env.VITE_APP_ID || '005',
        environment: 'mpt',
